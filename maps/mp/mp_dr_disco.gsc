//wut, why are you looking into my script?
...
main()
{
	...
	//addQueueTrigger("endmap_trig");
	//addQueueTrigger("trig_end_bush");
	//addQueueTrigger("trig_end_earthquake");
	//addQueueTrigger("trig_end_fall");
	//addQueueTrigger("trig_end_flash");
	//addQueueTrigger("trig_end_heavy");
	//addQueueTrigger("trig_end_ice");
	//addQueueTrigger("trig_end_marine");
	//addQueueTrigger("trig_end_old");
	//addQueueTrigger("trig_end_sniper");
...
starting_block()
{
	...
	ambientPlay("floor1",0);
	iPrintLnBold("^1READY");
	wait 2;
	iPrintLnBold("^3SET");
	wait 2;
	iPrintLnBold("^2DANCE^7!");
...
enter_floor2()
{
	...
	ambientStop(0);
	ambientPlay("floor2");
	iPrintLnBold("^1"+ player.name + " " + "^3" + "reached the 2nd floor!");
}
...
enter_floor3()
{
	...
	ambientStop(0);
	ambientPlay("floor3");
	iPrintLnBold("^6"+ player.name + " " + "^2" + "reached the 3rd floor!");
}
...
killzonefun1()
{
	...
	{
		trig waittill ("trigger", player);
		player SayAll("I'm such an idiot!");
		player suicide();
	}
}
killzonefloor2()
...
fun1b()
{
	...
	trig waittill ("trigger", player);
	iPrintLnBold (player.name + " got the mp5??!!!?!?!?!!111one");
	trig delete();
}
...
fun2()
{
	...
	{
		trig waittill("trigger",player);
		player SayAll("LOL, I have no idea what I'm doing here!");
		trig delete();
	}
}
...
fun3()
{
	...
	trig waittill("trigger");
	trig delete();
	iprintln("^2Something happend!");
	block notSolid();

	trigcreds waittill("trigger");
	trigcreds delete();
	iprintlnbold("^2DeltaBoss greets 'ya all!");
	iprintln("^2 Greetings to my clan SWAT|");
	iprintln("^3 Greetings to Tremolo4");
	iprintln("^4 Greetings to Universal Alliance!");
	iprintln("^5 Greetings to all my other friends!");
	wait 5;
	iprintln("Didn't read?");
	wait 2;
	iprintln("No problem!");
	wait 2;
	iprintln("Here they go again:");
	wait 1;
	iprintln("^2 Greetings to my clan SWAT|");
	wait 1;
	iprintln("^3 Greetings to Tremolo4");
...
fun4()
{
	...
	trig1 delete();
	block1 notSolid();
	iprintln("^3Did something just happen?");
	trig2 waittill("trigger");
	trig2 delete();
	block2 notSolid();
	iprintln("^2I'm pretty sure something just happend!");
	trig3 waittill("trigger",player);
	trig3 delete();
	player braxi\_rank::giveRankXP("",50);
	iPrintLnBold(player.name+" ^2is a pretty cool guy!");
}
...
end_old(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //old
{
	...
	self delete();
	block delete();
	iPrintlnBold(" ^1" + player.name + " ^7 prefers oldschool!" );
}
end_earthquake(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //quake
{
    ...
    while(1)
    {
		...
		iPrintlnBold( " ^1" + player.name + " ^1 makes the ground shake!" ); 
		wait 0.5;
...
end_marine(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //marine
{
	...
	while(1)
	{
		...
		finalJumper FreezeControls(1);
		level.activ FreezeControls(1);
		iPrintlnBold( " ^1" + player.name + " ^7 is on the move!" );
		wait 3;
		iPrintlnBold("^1 GET READY!");
		wait 0.5;
		iPrintlnBold("^1 3");
...
end_flash(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8)
{
    ...
    while(1)
    {
		...
		level.activ FreezeControls(1);      
		wait 0.05;
		iPrintlnBold( " ^6" + player.name + " ^5 is partying hard all night!" );
		wait 3;
		iPrintlnBold("^1 GET READY!");
		wait 1;
		iPrintlnBold("^1 3");
...
end_fall(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //speed prone
{
    ...
    while(1)
    {
		...
		finalJumper finalRoom(jump,"knife_mp",100);
		level.activ finalRoom(acti,"knife_mp",100);
		iPrintlnBold( " ^1" + player.name + " ^5 chose speed-proning!" );
		iPrintlnBold("^1 5 seconds until speed-boost, go prone now!");
		wait 2;
		iPrintlnBold("^1 3");
		wait 1;
		iPrintlnBold("^1 2");
		...
		iPrintlnBold("^1 1");
		wait 1;
		iPrintlnBold("^1 SPEED!!!");
		finalJumper SetMoveSpeedScale(10);
		level.activ SetMoveSpeedScale(10);
		
		finalJumper waiter(0);
		level.activ SetMoveSpeedScale(0.1);
		finalJumper SetMoveSpeedScale(0.1);
		self waittill( "trigger", player );
    }
}
...
end_spin(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //spin
{
    ...
    while(1)
    {
		...
		level.activ FreezeControls(1);      
		wait 0.05;
		iPrintlnBold( " ^1" + player.name + " ^5 spins my head right round!" );
		wait 3;
		iPrintlnBold("^1 GET READY!");
		wait 1;
		iPrintlnBold("^1 3");
...
end_heavy(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //heavy
{
	...
	while(1)
	{
		...
		level.activ FreezeControls(1);      
		wait 0.05;
		iPrintlnBold( " ^0" + player.name + " ^1 is banging HARD all night!" );
		wait 3;
		iPrintlnBold("^1 GET READY!");
		wait 1;
		iPrintlnBold("^1 3");
...
end_sniper(fn1,fn2,fn3,fn4,fn5,fn6,fn7,fn8) //sniper
{
	...
	while(1)
	{
		...
		level.activ FreezeControls(1);      
		wait 0.05;
		iPrintlnBold( " ^5" + player.name + " ^4 should watch the weatherforecast!" ); 
		wait 3;
		iPrintlnBold("^1 GET READY!");
		wait 1;
		iPrintlnBold("^1 3");
