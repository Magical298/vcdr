...
countdown_snip()
{
thread scripts\_slider::oben(self,"^53",level.randomcolor);
wait 1;
thread scripts\_slider::oben(self,"^52",level.randomcolor);
wait 1;
thread scripts\_slider::oben(self,"^11",level.randomcolor);
wait 3;
thread scripts\_slider::unten(self,"^1FIGHT!!",level.randomcolor);
...
WatchPistol()
{
	...
	while(1)
	{
		...
		// ====== Part for Queue Plugin ========
			...
			if(!isdefined(level.blueRooms))
			{
				level.blueRooms = true;
...
thread scripts\_slider::oben(self,"^52",level.randomcolor);
wait 1;
thread scripts\_slider::oben(self,"^51",level.randomcolor);
wait 3;
thread scripts\_slider::unten(self,"^1FIGHT!!",level.randomcolor);
