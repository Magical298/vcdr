main()
{
	...
	level.vip = loadFX("wunderwaffe/wunderwaffe_trail"); playLoopedFX(level.vip, 0.05, (-945, -1329, 124));
    ...
    level.music=[];
    level.music[0]["song"]    ="Brennan Heart - Be Here Now";	
...
messages()
{
	...
	wait 2;
	iprintlnBold("^7Map Made By: ^2VC'Fox");
	wait 10;
	for(;;)
{
	wait 0.1;
	iprintln("^2>> ^7Map Made By: ^2VC'Fox");
	wait 30;
	iprintln("^2>> ^7Thanks to ^1VC'Glen ^7For Fixing Errors"); 
	wait 30;
	iprintln("^2>> ^7Special Thanks to ^1Proodigy ^7 and ^1NitroFire"); 
	wait 30;
}	
...
trap1()
{
	...
	trig = getent("acti_trap_1", "targetname"); 
...
sniper_room()
{
	...
	jump = getEnt("sf_1", "targetname"); 
	acti = getEnt("sf_2", "targetname");
	...
	here = (-7115.55, 13358.6, 16.125);
	player setOrigin(here);
	player setPlayerAngles(jump.angles);
	
	here1 = (-6172.63, 12258.6, 16.125);
	level.activ setOrigin(here1);
...
fox_rtd()
{
	trig = getEnt("fox_rtd", "targetname");


		trig waittill("trigger", player);
		player FreezeControls(true);
		player iprintlnbold("^2Tell everyone how much you love ^3Fox's :ooooo");
		wait 3;
		player FreezeControls(1);
		player sayall("^3I LOVE FOX'S ^1<3333");
		wait 1;
		player FreezeControls(0);
		trig delete();
}
