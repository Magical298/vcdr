 ...
 // __  __                               _    _____           _       _       //
 //|  \/  |                             | |  / ____|         (_)     | |      //
 //| \  / | __ _ _ __     __ _ _ __   __| | | (___   ___ _ __ _ _ __ | |_ ___ //
 //| |\/| |/ _` | '_ \   / _` | '_ \ / _` |  \___ \ / __| '__| | '_ \| __/ __|//
 //| |  | | (_| | |_) | | (_| | | | | (_| |  ____) | (__| |  | | |_) | |_\__ \//
 //|_|  |_|\__,_| .__/   \__,_|_| |_|\__,_| |_____/ \___|_|  |_| .__/ \__|___///
 //             | |                                            | |            //
 //             |_|                                            |_|            //
 //                                                                           //
 // _             _______ _          _      _       __                        //
 //| |           |__   __| |        | |    (_)     / _|                       //
 //| |__  _   _     | |  | |__   ___| |     ___  _| |_ ___                    //
 //| '_ \| | | |    | |  | '_ \ / _ \ |    | \ \/ /  _/ _ \                   //
 //| |_) | |_| |    | |  | | | |  __/ |____| |>  <| ||  __/                   //
 //|_.__/ \__, |    |_|  |_| |_|\___|______|_/_/\_\_| \___|                   //
 //        __/ |                                                              //
 //       |___/                                                               //
 ///////////////////////////////////////////////////////////////////////////////
	...
	start_door()
{
	...
	wait 10;
	iprintln("^5Song: ^7Winter Wonderland - Michael Bubl�");
	...
	wait 10;
	iprintln("^5Song: ^7Feliz Navidad - Jos� Feliciano");
	object rotateyaw (100,4);
	object2 rotateyaw (-100,4);
	}
	else if(i == 2)
	...
	wait 10;
	iprintln("^5Song: ^7Santa Claus is coming to town - Michael Bubl�");
	object rotateyaw (100,4);
	object2 rotateyaw (-100,4);
	}
}
	...
	old_room()
{
	...
	door delete();
	iPrintlnBold( " ^7" + player.name + " can now break the final door!" );
	thread present_1();
	thread present_2();
	thread present_3();
	thread present_4();
	...
	northpole()
{
	...
	while(1)
    	{
        trig waittill ("trigger", player);
	player braxi\_rank::giveRankXP("", 123);         
	player SetOrigin(go.origin);
        player SetPlayerAngles( go.angles );
	player iPrintlnBold(" ^5MERRY CHRISTMAS! ");
	wait 8;        
	...
	creators()
{
	...
	wait 2;
	iprintln("^7Special thanks to ^5Sheep Wizard ^7for helping me with sounds and fx");
	wait 5;
	iprintln("^1MERRY CHRISTMAS ^5TO EVERYONE IN THE DEATHRUN COMMUNITY!");
	wait 15;
	...
	lastxmas()
{
	...
	wait 0.05 ;
	ambientPlay("wham");
	iprintln("^5Song: ^7Last Christmas - Wham");
	part movez (16,0.01);
}
	...
	lamp()
{
	...
	trigger waittill ("trigger", player);
	part delete();
	iPrintlnBold( "^7What are you doing Mr.^5" + player.name + "? " );
}