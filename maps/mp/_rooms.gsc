...
Nooby how about you make your own scripts?

Well.. if your already using any of my scripts give me credit for it...
...
fight_room()
{
    ...
    while(1)
    {
        ...
        level.fightplayer TakeAllWeapons();
        level.activ setPlayerangles( level.acti_superpower.angles );
        level.activ setOrigin( level.acti_superpower.origin );
        level.activ TakeAllWeapons();
        ...
        level.activ thread healthup();
        wep = "knife_mp";
        level.fightplayer giveWeapon(wep);
        level.activ giveWeapon(wep);
        level.fightplayer switchToWeapon(wep);
        level.activ switchToWeapon(wep);
        level.fightplayer SetMoveSpeedScale( 3 );
...
superpower()
{
    ...
    self iPrintLnBold("Press [[{+attack}]] To Fire Ability!");
}
