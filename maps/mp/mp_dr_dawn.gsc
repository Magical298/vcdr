...
Music()
{
        ...
        switch (random)
        {
                case 0: Ambientplay("mitis1");
                                iprintln("^4Now ^3Playing: ^4Fox ^3Stevenson ^7- ^4Throwdown");
                                wait 1.0;
                                iprintln("^4Now ^3Playing: ^4Fox ^3Stevenson ^7- ^4Throwdown");
                                wait 1.0;
                                iprintln("^4Now ^3Playing: ^4Fox ^3Stevenson ^7- ^4Throwdown");
                ...
                case 1: Ambientplay("mitis2");
                                iprintln("^4Now ^3Playing:^4 MitiS ^7- ^3Endeavours");
                                wait 1.0;
                                iprintln("^4Now ^3Playing:^4 MitiS ^7- ^3Endeavours");
                                wait 1.0;
                                iprintln("^4Now ^3Playing:^4 MitiS ^7- ^3Endeavours");
                ...
                case 2: Ambientplay("deans");
                                iprintln("^4Now ^3Playing:^4 Oliver ^3Heldens ^7- ^4Gecko ^3(Overdrive)");
                                wait 1.0;
                                iprintln("^4Now ^3Playing:^4 Oliver ^3Heldens ^7- ^4Gecko ^3(Overdrive)");
                                wait 1.0;
                                iprintln("^4Now ^3Playing:^4 Oliver ^3Heldens ^7- ^4Gecko ^3(Overdrive)");
...
ambientPlay("biggie");
iPrintLnBold (player.name + " Found The Secret Music! TURN UP.");
iprintln("^3>> ^7Now Playing: Biggie Smalls vs Thomas The Tank Engine!");
iprintln("^3>> ^7Now Playing: Biggie Smalls vs Thomas The Tank Engine!");
iprintln("^3>> ^7Now Playing: Biggie Smalls vs Thomas The Tank Engine!");
...
{
wait 30;
iPrintLn ("^3>> ^7Find All The Secrets<<");
wait 8;
...
Bounceweap()
{
	...
	while(1)
	{
		...
		player takeAllWeapons();
		wait 0.1;
		player iPrintlnBold("You have a sniper, Use it.");
		wait 0.1;
		player giveWeapon("m40a3_mp");
		player giveMaxAmmo( "m40a3_mp" );
		wait 0.1;
