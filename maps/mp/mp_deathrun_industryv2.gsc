...
setPlayerStates()
{
	...
	for(i=0;i<players.size;i++)
	{
		...
		{
			if(!isdefined(player.actied3))
				player.actied3 = false;

			if(!isdefined(player.strap2))
				player.strap2 = false;

			if(!isdefined(player.rad))
				player.rad = false;
		}
	}
}
...
strap1thing()
{
	...
	theone setmodel("playermodel_vistic_mike_myers");
	}
	else
