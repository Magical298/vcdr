...
main()
{
	...
	addQueueTrigger("s_trig");
	addQueueTrigger("b_trig");
	addQueueTrigger("o_trig");
	addQueueTrigger("k_trig");
	addQueueTrigger("r_trig");
...
lol()
{
	...
	{
	trig waittill("trigger", player);
	if(getSubStr(player getGuid(),24,32) == "d3b0a041")
	{
	iprintlnbold("^3Orki did just Bluff U!!");
	...
	{
		player iprintlnbold("^1U dont look like ^7Orki ?");
	}
	}
}
