main()
{
	...
	maps\mp\_load::main();
	maps\mp\mp_dr_easy_v2\_teleport1::main();
	maps\mp\mp_dr_easy_v2\_teleport2::main();
	maps\mp\mp_dr_easy_v2\_teleport3::main();
	maps\mp\mp_dr_easy_v2\_teleport4::main();
	maps\mp\mp_dr_easy_v2\_teleport5::main();
	maps\mp\mp_dr_easy_v2\_teleport6::main();
...
{
wait 20;
iprintln("^1>>^7Welcome to mp_deathrun_special");
wait 20;
iprintln("^1>>^7eBc|Legend Says ^3HELLO^1! ^7To You Jumpers");
wait 20;
iprintln("^1>>^7Map Creator ^5eBc|Legend");
wait 20;
iprintln("^1>>^7Play Fair and Have Fun :D");
wait 30;
}
}
...
{
wait(10);
thread drawInformation( 800, 0.8, 1, "Easy_v2" );
wait(6);
...
kniferoom()
{
    ...
    while(1)
    {
        ...
        iPrintlnBold( "^7" + player.name + " ^2Entered ^3Knife^7!" );
		wait 2;
		iPrintlnBold("3");
		wait 1;
		iPrintlnBold("2");
...
sniperoom()
{
    ...
    while(1)
    {
        ...
        iPrintlnBold( "^7" + player.name + " ^9Entered ^2Sniper^7!" );
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
		player TakeAllWeapons();
        level.activ setPlayerangles( acti.angles );
...
jumproom()
{
    ...
    while(1)
    {
        ...
        player switchToWeapon( "deserteagle_mp" );
        level.activ SwitchToWeapon( "deserteagle_mp" );
        iPrintlnBold( " ^7" + player.name + " ^8Entered ^5Jump^7!" );
		wait 2;
		iPrintlnBold("3");
		wait 1;
		iPrintlnBold("2");
...
trigger = GetEnt( "end", "targetname" );
	...
	trigger waittill ("trigger", user);
		{
		iprintlnbold( "^7 " + user.name + " ^4Finished First^7!!");
		wait 0.1;
		}
	}
}