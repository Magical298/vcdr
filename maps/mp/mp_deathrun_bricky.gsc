...
whos1st()
{
	...
	iprintlnbold("^3" + player.name + " ^5Has Finished the Map at first Place^1!");
	trig delete();
}
...
secrettp()
{
    ...
    while(1)
    {
		...
		iprintlnbold("^3" + player.name + " ^5Has Found the Secret^1!");
    }
}
...
secretback()
{
    ...
    while(1)
    {
        ...
        player SetOrigin(end.origin);
        player SetPlayerAngles( end.angles );
		iprintlnbold("^3" + player.name + " ^5Has Finished the Secret^1!");
	}
}
...
dele()
{
	...
	iPrintln (" ^1Why ^2you ^6Press ^3Use ^5Obvious");
	secretblock delete();
}
...
{	
     ...
     while(1)
    {
        ...
        level.activ setOrigin( acti.origin );
        level.activ TakeAllWeapons();
        level.activ GiveWeapon( "winchester1200_reflex_mp" );
        level.activ GiveWeapon( "winchester1200_reflex_mp" );         
        wait 0.05;
        player switchToWeapon( "winchester1200_reflex_mp" ); 
        level.activ SwitchToWeapon( "winchester1200_reflex_mp" );
        player FreezeControls(1);
		level.activ FreezeControls(1);
		noti = SpawnStruct();
