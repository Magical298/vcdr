...
//////////////////////////////////////////////////////////////////////
	...
	thread trap_42();
	 	...
	 	addQueueTrigger("finaltele1");
	 	addQueueTrigger("finaltele2");
  	addQueueTrigger("finaltele3");
	 	addQueueTrigger("finaltele4");
		addQueueTrigger("finaltele5");
		addQueueTrigger("finaltele1_way2");
	 	addQueueTrigger("finaltele2_way2");
  	addQueueTrigger("finaltele3_way2");
	 	addQueueTrigger("finaltele4_way2");
		addQueueTrigger("finaltele5_way2");
		addQueueTrigger("finaltele1_way3");
	 	addQueueTrigger("finaltele2_way3");
  	addQueueTrigger("finaltele3_way3");
	 	addQueueTrigger("finaltele4_way3");
		addQueueTrigger("finaltele5_way3");
		addQueueTrigger("finaltele1_way4");
	 	addQueueTrigger("finaltele2_way4");
  	addQueueTrigger("finaltele3_way4");
	 	addQueueTrigger("finaltele4_way4");
		addQueueTrigger("finaltele5_way4");
		addQueueTrigger("finaltele1_way5");
	 	addQueueTrigger("finaltele2_way5");
  	addQueueTrigger("finaltele3_way5");
	 	addQueueTrigger("finaltele4_way5");
		addQueueTrigger("finaltele5_way5");

       if(!isdefined(level.vcQueueCustom))
   level.vcQueueCustom = (-1320,7032,222);

      if(!isdefined(level.vcQueueCustom))
   level.vcQueueCustom = (-335,9862,76);
