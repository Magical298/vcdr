...
|__\____/________/_____/	   \\/________/
*/
main()
{
...
msgs()
{
	...
	{
		wait 5;
		iprintln("^5Join our server ip = ^7gs1.gpanel.eu:27256");
		wait 10;
		iprintln("^5Map created for x^6M^5 server");
		wait 20;
	}
}
...
mapfinished()
{
	...
	iprintlnBold("Thanks for playing ^5x^6M ^7map by eBc|Legend");
}
