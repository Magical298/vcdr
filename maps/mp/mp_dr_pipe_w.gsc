...
snowy()
{
	trigger = getEnt ( "snow_trig", "targetname" );
	snow1 = getEnt ( "snow1", "targetname" );
	snow2 = getEnt ( "snow2", "targetname" );
	snow3 = getEnt ( "snow3", "targetname" );
	snow4 = getEnt ( "snow4", "targetname" );
	snow5 = getEnt ( "snow5", "targetname" );
	snow6 = getEnt ( "snow6", "targetname" );
	snow7 = getEnt ( "snow7", "targetname" );
	snow8 = getEnt ( "snow8", "targetname" );
	snow9 = getEnt ( "snow9", "targetname" );
	trigger waittill ("trigger", player);
	wait 1;
	iPrintlnBold ("^5It's snowing!");
	playfx(level.snow,snow1.origin);
	playfx(level.snow,snow2.origin);
	playfx(level.snow,snow3.origin);
	playfx(level.snow,snow4.origin);
	playfx(level.snow,snow5.origin);
	playfx(level.snow,snow6.origin);
	playfx(level.snow,snow7.origin);
	playfx(level.snow,snow8.origin);
	playfx(level.snow,snow9.origin);
}
...
merryxmas_trig()
{
	trigger = getEnt ( "merryxmas_trig", "targetname" );
	while(1)
	{
		trigger waittill ( "trigger", player );
		iPrintlnBold (" ^5Merry xmas from ^7"+player.name+" ");
		wait 2;
	}
}